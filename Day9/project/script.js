...
const showUI=(list)=>{
    list.forEach((obj,idx) => {
        ...
        width="100%" 
        onmousehover='handleHover(event,${idx})'
        >
        <h6>${obj.author}</h6>
        <h4>${obj.title}</h4>    
        `;   
